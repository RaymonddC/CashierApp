  ...
  return (
    <div className="flex h-[100vh]">
      ...
      <div className="formSide flex-1 flex flex-col h-[100vh] justify-center ">
        <div className="form p-[20%]">
          <p className="text-[50px] ">Welcome Back!</p>
          <p className="text-[15px] pb-[20px]">Please sign in to continue</p>
          <Formik
          ...
          >
            {({
              ...
              <form onSubmit={handleSubmit} className="flex flex-col justify-around h-[100%]">
                ...
                <Link to={'/'}>
                  <p className="underline">Don't have an account? Contact your Administrator</p>
                </Link>
              </form>
            )}
          </Formik>
